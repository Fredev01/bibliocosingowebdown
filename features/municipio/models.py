...
class MunicipioForm(FlaskForm):
    ...
    nombre = StringField ("*Nombre del municipio", [DataRequired(), Length(max=100),  Regexp(r'^[a-zA-ZáéíóúÁÉÍÓÚ\s]+$', message="Solo se permiten letras y acentos.")], description="Campo obligatorio")
